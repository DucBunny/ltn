...
export default function RSVPForm({ guestName, ownerName }: RSVPProps) {
      ...
      <section className="mx-auto max-w-2xl px-4 py-16 text-center">
        <motion.div
          ...
          <p className="text-green-600">
            Xác nhận của bạn đã được gửi thành công. Hẹn gặp bạn tại buổi lễ
            nhé!
          </p>
        </motion.div>
      </section>
  ...
  return (
    <section id="rsvp" className="mx-auto max-w-2xl px-4 py-16">
      <div className="rounded-3xl border-t-4 border-[#C62534] bg-white p-6 shadow-xl md:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-gray-300 px-4 py-2 outline-none focus:ring-2 focus:ring-[#C62534]"
            />
          </div>
          ...
          <button
            ...
            className="flex w-full justify-center rounded-xl bg-[#C62534] py-3 font-bold text-white shadow-md transition hover:bg-red-800">
