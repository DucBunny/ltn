  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        <Card className="relative flex flex-col items-center overflow-hidden border-0 bg-white p-0 text-center shadow-2xl">
          ...
          {/* Nội dung chính */}
          <CardContent className="z-10 flex w-full flex-col items-center p-6">
            <motion.div
            ...
            <div className="relative mt-2">
              <Button
                asChild
                className="relative h-auto overflow-hidden rounded-full bg-[#C62534] px-10 py-3 text-xl font-semibold text-white shadow-lg transition-colors duration-300 hover:bg-[#a51e2b]">
                <motion.button
